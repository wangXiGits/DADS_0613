...
//
//  @ Project : Untitled
//  @ File Name : No8TwoWayParser.java
//  @ Date : 2017/6/11
//  @ Author : 
//
//
...
import com.cloud.mina.util.EtcommDataTransferUtil;
import com.cloud.mina.util.Logger;


/** */
public class No8TwoWayParser extends MilinkSportComponent
{
	@Override
...
//		}
	...
	private No8TwoWayPacket handle5MinutesDetailPacket(IoBuffer buffer) {
		...
		Logger.writeLog("in method handleNo8DataForTwoWay detail package carry "+max_times_tran+" hours exercise data");
		for(int i=0;i<=24;i++)
		{
...
//		    stepcount2data.append("\"");// alter on 2014/06/30
	 ...
	 * void
	 */
	public No8TwoWayPacket handle1MinuteDetailPacket(byte[] b) {
		No8TwoWayPacket packet = new No8TwoWayPacket();
		...
		String patientID = DeviceIDResolver.searchPatientidByDeviceid(deviceID);
		String company = DeviceIDResolver.searchCompanyByDeviceid(deviceID);
		Logger.writeLog("in method handleNo8DataForTwoWay device_id:"+deviceID+" patientID="+patientID+" company"+company);
...
//		    stepcount2data.append("\"");
	 ...
	 * void
	 */
	private No8TwoWayPacket transferToFiveNo8TwoWay(String detail_data, String stepdate, No8TwoWayPacket packet) {
